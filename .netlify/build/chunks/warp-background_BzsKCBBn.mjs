import { e as createAstro, c as createComponent, f as addAttribute, k as renderScript, d as renderTemplate, l as defineScriptVars, u as unescapeHTML, r as renderComponent, n as renderHead, g as renderSlot } from './astro/server_CRB85aQe.mjs';
/* empty css                         */
import { Font as $$Font } from './_astro_assets_BR38Zqfk.mjs';
import 'clsx';
...
const $$ClientRouter = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<meta name="astro-view-transitions-enabled" content="true"><meta name="astro-view-transitions-fallback"${addAttribute(fallback, "content")}>${renderScript($$result, "C:/Users/maind/Documents/GitHub/githopes.github.io/node_modules/astro/components/ClientRouter.astro?astro&type=script&index=0&lang.ts")}`;
}, "C:/Users/maind/Documents/GitHub/githopes.github.io/node_modules/astro/components/ClientRouter.astro", void 0);
...
}, "C:/Users/maind/Documents/GitHub/githopes.github.io/node_modules/astro-loading-indicator/src/LoadingIndicator.astro", void 0);
...
const $$RootLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  const defaultTitle = "Nikola Tesla";
  const defaultDescription = "Nikola Tesla was a Serbian-American inventor, electrical engineer, mechanical engineer, and futurist who is best known for his contributions to the design of the modern alternating current (AC) electricity supply system.";
...
}, "C:/Users/maind/Documents/GitHub/githopes.github.io/src/layouts/RootLayout.astro", void 0);
